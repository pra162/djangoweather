...
def home(request):
	...
	if request.method == "POST":
		...
		api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=5&API_KEY=A68157F4-A319-45D2-A6EB-00CE229DE889")
		...
		if api[0]['Category']['Name'] == "Good":
			...
			category_color = "usg"
		elif [0]['Category']['Name'] == "Unhealthy":
		...
		api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=5&API_KEY=A68157F4-A319-45D2-A6EB-00CE229DE889")
